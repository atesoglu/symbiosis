...
public class ExceptionMiddleware
{
    ...
    private async Task HandleExceptionAsync(HttpContext context, Exception ex)
    {
        ...
        if (_environment.IsDevelopment())
        {
            ...
            if (ex.StackTrace != null) response.AddError("_stack-trace", ex.StackTrace);
            if (ex.InnerException != null) response.AddError("_inner-exception", ex.InnerException.ToString());
        }
        ...
        if (ex is ExceptionBase exceptionBase)
        {
            ...
            switch (ex)
            {
                ...
                case NotFoundException notFoundException:
                    ...
                    logLevel = LogLevel.Debug;
                    response.AddError("Resource cannot be found.");
                    break;
